...
> **Nota del 22/09/2026**: questo e' il documento di diagnosi e piano, scritto
> **prima** di eseguire gli esperimenti — vale come registro di come e' nata
> la scelta del BM25, non come resoconto di cosa e' successo poi (il piano e'
> cambiato più volte: e5 e' stato scartato e poi riadottato per il
> troncamento, il BM25 e' passato da implementazione in memoria a nativo in
> Qdrant, il reranker e' stato confrontato e lasciato invariato). Per l'esito
> reale, esperimento per esperimento: `doc/TEST_RECUPERO_IBRIDO.md`. Per lo
> stato attuale del sistema: `doc/SISTEMA.md`.
