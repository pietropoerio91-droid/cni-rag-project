...
1.7 Vincoli hardware nei sistemi RAG locali — requisiti di memoria, CPU/GPU, trade-off tra qualità e risorse disponibili
...
4.1 Hardware utilizzato — PC Windows (i7-1355U, 16GB, Intel UHD) e MacBook Pro (i5 3.1GHz, 8GB, Iris Plus 650)
...
5.5 Transizione hardware: impatto sulle performance — confronto tra PC Windows e MacBook Pro, differenze in tempi di risposta e qualità
